...
function compile( name, tmpl, parent, options ) {
	...
	function tmplOrMarkupFromStr( value ) {
		// If value is of type string - treat as selector, or name of compiled / Return the template object, if already compiled, or the markup string
	...
	if ( tmplOrMarkup !== undefined ) {
		...
		if ( tmplOrMarkup.fn || tmpl.fn ) {
			...
			// tmplOrMarkup is a markup string, not a compiled / Create template object
...
tags({
	"if": function() {
		...
		view.onElse = function( tagObject, args ) {
			...
			// By passing the view, we inherit data context from the parent view, and the content is treated as a layout / (so if the data is an array, it will not iterate over the data
		};
