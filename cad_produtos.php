                    ...
                    <form class="form-horizontal form-bordered" id="registroProdutos" name="registroProdutos">
                        ...
                        <div class="row">
                            <div class="col-sm-8 text-center">
                                <span name="registrarProdutos" id="registrarProdutos" onclick="salvar()" class="btn btn-primary text-light mt-2"><i class="loading-icon fa fa-spinner fa-spin oculto"></i> Inserir Produto</span>
