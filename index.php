    ...
    <body>
        ...
        <section class="body-sign">
            <div class="center-sign">
                    ...
                    <div class="card-body">
                        ...
                        <form id="Frmlogin">
                            ...
                            <div class="row">
                                ...
                                -->
                                    <span name="btnLogar" id="btnLogar" class="mb-1 mt-1 mr-1 btn btn-danger"
                                        onclick="Entrar()"><i class="fas fa-unlock-alt"></i> Acessar</span>
                                </div>
                ...
                <p class="text-center text-muted mt-3 mb-3 text-danger">&copy; Vision Premium | Copyright 2020. All
                    Rights Reserved.</p>
            </div>
        </section>
        <!-- end: page -->
